    ...
    define([], function() {
        return [
            ...
            function($scope,$httpService,config,params,$routeParams,eventBusService,controllerName,loggingService) {
            	...
            	$scope.form = {};
            	$scope.form.STATE = 0;
            	$scope.form.PUBLICFLAG = 0;
            	
            	
            	$httpService.css("http://portal.sjedu.cn/ewebeditor/_example/example.css");
               
            	$httpService.post(config.findTeacherURL, {}).success(function(data) {
        			$scope.teachersData = data.data;
        			$scope.$apply();
	            });
            	...
            	eventBusService.subscribe(controllerName, controllerName+'.save', function(event, btn) {
            		...
            		$httpService.post(config.addURL, $scope.form).success(function(data) {
            			if(data.code=="0000"){
	                		...
	                		eventBusService.publish(controllerName,'appPart.data.reload', {"scope":"dyjh"});
